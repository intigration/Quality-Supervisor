  ...
  <div class="flex justify-center flex-wrap items-stretch gap-6 mb-4 relative">
    ...
    <div class="
      ...
      backdrop-filter backdrop-blur-md bg-opacity-40 border border-stone-800">
        <button
          ...
          >Close</button>
        <p class="text-xl block text-center font-bold">Setting up your dashboard</p>
    ...
    <div class="flex justify-center flex-col items-center gap-6">
      ...
      <div class="rounded-box bg-front shadow-md w-96 p-4">
        <h3 class="text-primary text-2xl">Quality Gate Qualification</h3>
        <p class="text-lg">
      ...
      <h3 class="text-primary text-2xl">Risk Board</h3>
        ...
        <p class="text-lg">
          Ready for Development <b>{checklists.value.length} out of {totalProgress.value.outOf}</b> items
        </p>
        <progress
          class="progress w-80"
          value={totalProgress.value.completed}
