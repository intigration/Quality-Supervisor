...
export default component$(() => {
  ...
  const rt = ['infra', 'research', 'automation', 'blogs', 'framework' ];
          ...
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              <details>
                ...
                <ul class="p-2 bg-base-100 rounded-t-none z-10">
                  {rt.map(menu => (
                    <li key={`checklist-nav-${menu}`} class={`hover:bg-white-600 hover:bg-opacity-15`}>
                      <a href={`/${menu}`}>
                        {menu}
                      </a>
                    </li>
            ...
            <li>    <a href="/automation/python/">
              <Icon class="mr-2" icon="articles" width={16} height={16} />Python
            </a>
        </li>
            <li>
            <a href={`/about`}
